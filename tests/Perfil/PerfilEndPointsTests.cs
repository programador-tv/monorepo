...
public class PerfilsEndPointsTests
{
    ...
    [Fact]
    public async Task TryCreateOrUpdate_ShouldReturnOk_WhenPerfilIsCreated()
    {
        ...
        var expectedResponse = new CreateOrUpdatePerfilResponse(
            status: StatusCreateOrUpdatePerfil.PerfilCreated,
            Id: perfil.Id
        );

        mockLogic.Setup(logic => logic.TryCreateOrUpdate(request)).ReturnsAsync(expectedResponse);

        var result = await PerfilsEndPoints.TryCreateOrUpdate(mockLogic.Object, request);

        var okResult = Assert.IsType<Ok<CreateOrUpdatePerfilResponse>>(result);
        var responseValue = Assert.IsType<CreateOrUpdatePerfilResponse>(okResult.Value);

        Assert.Equal(expectedResponse.status, responseValue.status);
        Assert.Equal(expectedResponse.Id, responseValue.Id);
    }

    [Fact]
    public async Task TryCreateOrUpdate_ShouldReturnOk_WhenPerfilIsUpdated()
    {
        var request = new CreateOrUpdatePerfilRequest(
            Nome: "Test",
            Token: "12345qwerty",
        ...
        var expectedResponse = new CreateOrUpdatePerfilResponse(
            status: StatusCreateOrUpdatePerfil.PerfilUpdated,
            Id: perfil.Id
        );
    ...
    [Fact]
    public async Task TryCreateOrUpdate_ShouldReturnOk_ButStatusOfUsernameAlreadyInUse()
    {
        var request = new CreateOrUpdatePerfilRequest(
            Nome: "Test",
            Token: "12345qwerty",
        ...
        var expectedResponse = new CreateOrUpdatePerfilResponse(
            status: StatusCreateOrUpdatePerfil.UsernameAlreadyInUse,
            Id: Guid.Empty
        );
    ...
    [Fact]
    public async Task TryCreateOrUpdate_ShouldReturnBadRequest_OnException()
    {
        var request = new CreateOrUpdatePerfilRequest(
            Nome: "Test",
            Token: "12345qwerty",
        ...
        mockLogic
            .Setup(logic => logic.TryCreateOrUpdate(request))
            .ThrowsAsync(new Exception("Erro de teste"));
