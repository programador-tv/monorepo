...
var FullCalendar = (function (e) {
  ...
  function E(e, t, n, r, i) {
    ...
    e: if ("style" === t)
      ...
      (s = t !== (t = t.replace(/Capture$/, ""))),
        ...
        (e.l[t + s] = n),
        n
          ? r || e.addEventListener(t, s ? D : S, s)
          : e.removeEventListener(t, s ? D : S, s);
  ...
  var ge =
      ...
      60103,
    pe =
      /^(?:accent|alignment|arabic|baseline|cap|clip(?!PathU)|color|dominant|fill|flood|font|glyph(?!R)|horiz|image|letter|lighting|marker(?!H|W|U)|overline|paint|default|shape|stop|strikethrough|stroke|text(?!L)|transform|underline|unicode|units|v|vector|vert|word|writing|x(?!C))[A-Z]/,
  ...
  function _e(e, t = e, n = t.firstChild) {
    if (!Re.has(e)) {
      const r = document.createComment(" fullcalendar styles "),
        i = document.createComment(" END fullcalendar styles ");
      t.insertBefore(i, n),
        t.insertBefore(r, i),
        Re.set(e, i),
        (function (e) {
          for (const t of Ce) Te(t, e);
        })(i);
    }
  }
  function Te(e, t) {
    ...
    r && (n.nonce = r), (n.innerText = e), t.parentNode.insertBefore(n, t);
  }
  let ke;
  ...
  function Je(e) {
    (e.style.userSelect = "none"), e.addEventListener("selectstart", Le);
  }
  function Ke(e) {
    (e.style.userSelect = ""), e.removeEventListener("selectstart", Le);
  }
  function et(e) {
  ...
  function Fn(e, t, n, r, i, s, o, a, l, c, d, u, h) {
    return {
      ...
      createScrollResponder: (e) =>
        new Wn(e, c, ft(n.scrollTime), n.scrollTimeReset),
  ...
  class Vn extends A {
    shouldComponentUpdate(e, t) {
      return (
        this.debug && console.log(xn(e, this.props), xn(t, this.state)),
        !_n(this.props, e, this.propEquality) ||
          !_n(this.state, t, this.stateEquality)
      );
    }
    safeSetState(e) {
      _n(
  ...
  class gr {
    constructor(e) {
      (this.props = e),
        (this.nowDate = fr(e.nowInput, e.dateEnv)),
        this.initHiddenDays();
    }
    buildPrev(e, t, n) {
  ...
  function Sr(e, t, n, r, i = Ar(n), s, o) {
    let { refined: a, extra: l } = Dr(e, n, i),
      c = (function (e, t) {
        let n = null;
        e && (n = e.defaultAllDay);
  ...
  function Dr(e, t, n = Ar(t)) {
    return vn(e, n);
  }
  function Ar(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Ir), Er),
  ...
  function zr(e) {
    return Object.assign(
      Object.assign(Object.assign({}, Ir), Br),
      ...
      case "RECEIVE_EVENTS":
        return (function (e, t, n, r, i, s) {
          if (t && n === t.latestFetchId) {
            ...
            return r && (n = mr(n, r, s)), Tr(Fr(e, t.sourceId), n);
          }
          return e;
      ...
      (function (e) {
        ...
        t =
          !0 === e
            ...
            ? [e]
            : [];
        return (t = t.map((e) => Object.assign(Object.assign({}, Gr), e))), t;
      })(e),
      null,
      t
    );
  ...
  function qr(e, t, n) {
    n.emitter.trigger(
      "select",
      Object.assign(Object.assign({}, Yr(e, n)), {
  ...
  function Jr(e, t, n, r, i) {
    ...
    return (
      ...
      l.range.end < l.range.start &&
        (l.range.end = Zr(t.allDay, l.range.start, i)),
      l
    );
  }
  class Kr {
  ...
  class ei {
    ...
    setProp(e, t) {
      if (e in br)
        ...
        (t = yr[e](t)), this.mutate({ standardProps: { publicId: t } });
      else if (e in yr)
        (t = yr[e](t)), this.mutate({ standardProps: { [e]: t } });
      else if (e in Ir) {
        let n = Ir[e](t);
        (n =
          "color" === e
    ...
    get source() {
      ...
      return e
        ? new Kr(this._context, this._context.getCurrentData().eventSources[e])
        : null;
    }
    get start() {
  ...
  const bi = { start: yn, end: yn, allDay: Boolean };
  function Ei(e, t, n) {
    let r = (function (e, t) {
  ...
  class Ti extends Gn {
    ...
    render() {
      ...
      return _i() || s.push("fc-liquid-hack"), e.children(s, i, r, n);
    }
    componentDidMount() {
  ...
  class Oi {
    ...
    addEvent(e, t) {
      ...
      if (t instanceof Kr) n = t.internalEventSource;
      ...
      if (i) {
        ...
        return (
          this.dispatch({ type: "ADD_EVENTS", eventStore: Rr(i) }),
          this.triggerEventAdd(e),
          e
        );
      }
    ...
    triggerEventAdd(e) {
      ...
      t.trigger("eventAdd", {
        ...
        relatedEvents: [],
        revert: () => {
          this.dispatch({ type: "REMOVE_EVENTS", eventStore: ti(e) });
        },
      });
    }
    getEventById(e) {
      ...
      for (let i in n) {
        let s = n[i];
        if (s.publicId === e) {
          if (s.recurringDef) return new ei(t, s, null);
          for (let e in r) {
            let n = r[e];
            if (n.defId === s.defId) return new ei(t, s, n);
          }
        }
      }
      return null;
    ...
    getEventSources() {
      let e = this.getCurrentData(),
        t = e.eventSources,
        n = [];
      for (let r in t) n.push(new Kr(e, t[r]));
      return n;
    }
    getEventSourceById(e) {
      let t = this.getCurrentData(),
        n = t.eventSources;
      e = String(e);
      for (let r in n) if (n[r].publicId === e) return new Kr(t, n[r]);
      return null;
    }
    addEventSource(e) {
      let t = this.getCurrentData();
  ...
  class Ui {
    ...
    splitProps(e) {
      let t = this.getKeyInfo(e),
        ...
        l = {};
      this.eventUiBuilders = Dn(t, (e, t) => this.eventUiBuilders[t] || Gt(Wi));
      for (let n in t) {
        let c = t[n],
          d = s[n] || zi,
  ...
  const Vi = an({ year: "numeric", month: "long", day: "numeric" }),
    Gi = an({ week: "long" });
  function Qi(e, t, n = "day", r = !0) {
    const { dateEnv: i, options: s, calendarApi: o } = e;
    let a = i.format(t, "week" === n ? Gi : Vi);
    if (s.navLinks) {
      let e = i.toDate(t);
      const l = (e) => {
        let r =
  ...
  function Ki(e, t = !1, n) {
    let r = n ? e.getBoundingClientRect() : es(e),
      i = Ji(e, t),
      s = {
  ...
  class ns {
    ...
    similarTo(e) {
      return (
        rs(this.tops || [], e.tops || []) &&
        rs(this.bottoms || [], e.bottoms || []) &&
        rs(this.lefts || [], e.lefts || []) &&
        rs(this.rights || [], e.rights || [])
      );
    }
  }
  function rs(e, t) {
  ...
  class ls {
    ...
    splitEntry(e, t, n) {
      ...
      return (
        ...
        r
          ? (n.push(
              { index: e.index, thickness: e.thickness, span: hs(o, s) },
              ...i
            ),
            r)
          : (n.push(e), 0)
    ...
    insertEntryAt(e, t) {
      ...
      -1 === t.lateral
        ? (fs(r, t.level, t.levelCoord), fs(n, t.level, [e]))
        : fs(n[t.level], t.lateral, e),
        (this.stackCnts[ds(e)] = t.stackCnt);
    }
    findInsertion(e) {
      let {
          levelCoords: t,
      ...
      for (let u = 0; u < s; u += 1) {
        ...
        let h,
          f = n[u],
          g = gs(f, e.span.start, cs),
          p = g[0] + g[1];
        for (; (h = f[p]) && h.span.start < e.span.end; ) {
          let e = s + h.thickness;
          e > o && ((o = e), (c = h), (a = u), (l = p)),
            e === o && (d = Math.max(d, i[ds(h)] + 1)),
            (p += 1);
        }
      }
      let u = 0;
      ...
      let h = -1;
      return (
        u < s && t[u] === o && (h = gs(n[u], e.span.end, cs)[0]),
        {
          touchingLevel: a,
          touchingLateral: l,
          touchingEntry: c,
  ...
  const ms = {},
    vs = { startTime: ft, duration: ft, create: Boolean, sourceId: String };
  function ys(e) {
    let { refined: t, extra: n } = vn(e, vs);
    return {
  ...
  class ws extends Gn {
    render() {
      ...
      return p(
        ...
        {
          elTag: "th",
          elClasses: [Es, ...Fi(o, n), ...(e.extraClassNames || [])],
          elAttrs: Object.assign(
        ...
        (n) =>
          p(
            ...
            p(n, {
              ...
              elAttrs: { "aria-label": t.format(s, As) },
            })
          )
      );
    }
  ...
  class Cs extends A {
    constructor(e, t) {
      super(e, t),
        (this.initialNowDate = fr(t.options.now, t.dateEnv)),
    ...
    computeTiming() {
      ...
      return (
        (s = Math.min(864e5, s)),
        {
          currentState: { nowDate: r, todayRange: Rs(r) },
          nextState: { nowDate: i, todayRange: Rs(i) },
          waitMs: s,
        }
      );
    }
  ...
  class xs extends Gn {
    constructor() {
      super(...arguments), (this.createDayHeaderFormatter = Gt(_s));
    }
    render() {
      let { context: e } = this,
        {
  ...
  class Ms {
    ...
    _sliceBusinessHours(e, t, n, r, ...i) {
      return e
        ? this._sliceEventStore(mr(e, Is(t, Boolean(n)), r), {}, t, n, ...i).bg
        : [];
    }
  ...
  function Os(e, t, n) {
    ...
    return Ps({ eventDrag: e }, n);
  }
  function Ns(e, t, n) {
    return !!ar(t.validRange, e.range) && Ps({ dateSelection: e }, n);
  }
  function Ps(e, t) {
    ...
    return (
      !(
        ...
        !(function (e, t, n, r) {
          let i = t.getCurrentData(),
            ...
            a = o.defs,
            l = o.instances,
            c = ai(a, s.isEvent ? e.eventUiBases : { "": i.selectionConfig });
          r && (c = Dn(c, r));
          let d =
              ((g = e.eventStore),
          ...
          for (let r in l) {
            let o = l[r],
              ...
              p = c[o.defId],
              m = a[o.defId];
            if (!Bs(p.constraints, g, d, e.businessHours, t)) return !1;
            ...
            for (let e of p.allows) {
              let i,
                ...
                a = b.defs[m.defId],
                l = b.instances[r];
              if (((i = a ? new ei(t, a, l) : new ei(t, m)), !e(Yr(s, t), i)))
                return !1;
            }
          }
          return !0;
      ...
      !(
        ...
        !(function (e, t, n, r) {
          ...
          r && (c = r(c));
          if (!Bs(c.constraints, l, i, e.businessHours, t)) return !1;
          ...
          for (let e in o) {
            ...
            if (or(l, n.range)) {
              ...
              if (u && !u(new ei(t, s[n.defId], n), null)) return !1;
            }
          }
          for (let e of c.allows) {
            let r = Object.assign(Object.assign({}, n), a);
            if (!e(Yr(r, t), null)) return !1;
          }
          return !0;
        })(e, t, n, r)
      )
  ...
  function Bs(e, t, n, r, i) {
    for (let s of e) if (!Us(js(s, t, n, r, i), t)) return !1;
    return !0;
  }
  ...
  ro.addStateEquality({ scrollerClientWidths: Cn, scrollerClientHeights: Cn });
  class io extends Gn {
    constructor() {
      super(...arguments),
        (this.handleEl = (e) => {
          (this.el = e), e && si(e, this.props.seg);
        });
    }
    render() {
      const { props: e, context: t } = this,
  ...
  class co extends Gn {
    constructor() {
      super(...arguments), (this.refineRenderProps = Qt(ho));
    }
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
      ...
      return p(
        Jn,
        Object.assign({}, e, {
          elClasses: [...Fi(r, t.theme), ...(e.elClasses || [])],
          elAttrs: Object.assign(
            Object.assign({}, e.elAttrs),
            r.isDisabled ? {} : { "data-date": Wt(e.date) }
          ),
          renderProps: r,
    ...
    updateSize() {
      let { isRtl: e } = this.context,
        ...
        i = (function (e) {
          ...
          for (let e of t) {
            let t = Pi(n, e.getBoundingClientRect());
            if (!t) return null;
            n = t;
          }
          return n;
  ...
  function Do(e) {
    ...
    let { hiddenSegs: t } = e;
    return { start: Ao(t), end: ((n = t), n.reduce(Co).eventRange.range.end) };
    var n;
  }
  function Ao(e) {
  ...
  var Ro = {
      ...
      computeEdges: Ji,
      computeFallbackHeaderFormat: bs,
      computeInnerRect: Ki,
      computeRect: es,
      ...
      getIsRtlScrollbarOnLeft: Zi,
      getRectCenter: Bi,
      getRelevantEvents: xr,
      getScrollGridClassNames: Js,
      getScrollbarWidths: Xi,
  ...
  function Wo(e, t, n, r) {
    ...
    return Dn(
      (function (e, t) {
        let n,
          r = {};
        for (n in e) jo(n, r, e, t);
        for (n in t) jo(n, r, e, t);
        return r;
      })(i, s),
      (e) =>
        (function (e, t, n, r, i) {
  ...
  function Vo(e, t, n, r) {
    ...
    switch (t.type) {
      ...
      case "FETCH_EVENT_SOURCES":
        return Yo(
          e,
          t.sourceIds ? An(t.sourceIds) : Xo(e, r),
          i,
          t.isRefetch || !1,
          r
        );
      ...
      eventSourceDefs: [
        {
          ...
          fetch(e, t, n) {
            ...
            wi(
              e.eventSource.meta.bind(null, Di(e.range, r)),
              (e) => t({ rawEvents: e }),
              n
            );
          },
    ...
    No({
      ...
      propSetHandlers: {
        dateProfile: function (e, t) {
          t.emitter.trigger(
            "datesSet",
            Object.assign(Object.assign({}, Di(e.activeRange, t.dateEnv)), {
              view: t.viewApi,
            })
          );
        },
  ...
  class da {
    constructor(e) {
      (this.computeCurrentViewData = Gt(this._computeCurrentViewData)),
        ...
        (this.buildDateEnv = Gt(ua)),
        (this.buildTheme = Gt(ha)),
        (this.parseToolbars = Gt(na)),
        (this.buildViewSpecs = Gt(Wo)),
        (this.buildDateProfileGenerator = Qt(fa)),
        (this.buildViewApi = Gt(ga)),
        (this.buildViewUiProps = Qt(va)),
        (this.buildEventUiBySource = Gt(pa, Cn)),
        (this.buildEventUiBases = Gt(ma)),
        (this.parseContextBusinessHours = Qt(ba)),
      ...
      let l = Fo(n.calendarOptions, o, a),
        c = {
      ...
      ya(c, a) && this.emitter.trigger("loading", !0),
        (this.state = c),
        this.updateData(),
    ...
    _handleAction(e) {
      ...
      this.data &&
        ...
        ("PREV" !== e.type && "NEXT" !== e.type && lr(d.currentRange, c)) ||
  ...
  class Ra extends Vn {
    constructor() {
      super(...arguments),
        ...
        (this.buildViewPropTransformers = Gt(_a)),
        (this.buildToolbarProps = Gt(xa)),
        ...
        (this.registerInteractiveComponent = (e, t) => {
          let n = (function (e, t) {
            ...
            r = [wa, Ca]
              ...
              .map((e) => new e(n));
          (this.interactionsStore[e.uid] = r), (Ii[e.uid] = n);
        }),
  ...
  class Oa {
      ...
      (this.subjectEl = null),
        ...
        (this.handleMouseDown = (e) => {
          if (
            ...
            this.emitter.trigger("defaultdown", t),
        ...
        (this.handleMouseMove = (e) => {
          ...
          this.recordCoords(t), this.emitter.trigger("defaultmove", t);
        }),
        (this.handleMouseUp = (e) => {
          document.removeEventListener("mousemove", this.handleMouseMove),
            document.removeEventListener("mouseup", this.handleMouseUp),
            this.emitter.trigger("defaultup", this.createEventFromMouse(e)),
            this.cleanup();
        }),
        (this.handleTouchStart = (e) => {
          if (this.tryStart(e)) {
            ...
            this.emitter.trigger("defaultdown", t), this.initScrollWatch(t);
            let n = e.target;
            this.shouldIgnoreMove ||
        ...
        (this.handleTouchEnd = (e) => {
          if (this.isDragging) {
            ...
            t.removeEventListener("touchmove", this.handleTouchMove),
              ...
              this.emitter.trigger("defaultup", this.createEventFromTouch(e)),
              this.cleanup(),
              (this.isTouchDragging = !1),
              (ka += 1),
              setTimeout(() => {
                ka -= 1;
              }, ms.touchMouseIgnoreWait);
          }
        }),
        ...
        (this.handleScroll = (e) => {
          if (!this.shouldIgnoreMove) {
            ...
            this.emitter.trigger("defaultmove", {
              origEvent: e,
        ...
        (Ma += 1),
        1 === Ma && window.addEventListener("touchmove", Na, { passive: !1 });
    }
    destroy() {
      this.containerEl.removeEventListener("mousedown", this.handleMouseDown),
        ...
        (Ma -= 1),
        Ma || window.removeEventListener("touchmove", Na, { passive: !1 });
    }
    tryStart(e) {
    ...
    shouldIgnoreMouse() {
      return ka || this.isTouchDragging;
    }
    cancelTouchScroll() {
      this.isDragging && (Ia = !0);
    }
    initScrollWatch(e) {
  ...
  class Ba extends Ha {
    ...
    computeClientRect() {
      return Ki(this.scrollController.el);
    }
  }
  class ja extends Ha {
    constructor(e) {
  ...
  const za = "function" == typeof performance ? performance.now : Date.now;
  class Ua {
    constructor() {
      (this.isEnabled = !0),
        ...
        (this.defaultScreenX = null),
        (this.defaultScreenY = null),
        (this.isAnimating = !1),
        ...
        (this.animate = () => {
          if (this.isAnimating) {
            let e = this.computeBestEdge(
              this.defaultScreenX + window.pageXOffset,
              this.defaultScreenY + window.pageYOffset
            );
            if (e) {
              let t = za();
    ...
    handleMove(e, t) {
      if (this.isEnabled) {
        let n = e - window.pageXOffset,
          ...
          i = null === this.defaultScreenY ? 0 : r - this.defaultScreenY,
          s = null === this.defaultScreenX ? 0 : n - this.defaultScreenX;
        i < 0 ? (this.everMovedUp = !0) : i > 0 && (this.everMovedDown = !0),
          s < 0
            ? (this.everMovedLeft = !0)
            : s > 0 && (this.everMovedRight = !0),
          (this.defaultScreenX = n),
          (this.defaultScreenY = r),
          this.isAnimating ||
            ((this.isAnimating = !0), this.requestAnimation(za()));
      }
    }
    stop() {
      if (this.isEnabled) {
  ...
  class Wa extends ps {
      ...
      super(e),
        ...
        (this.ondefaultDown = (e) => {
          this.isDragging ||
            ...
            this.emitter.trigger("defaultdown", e),
            this.isInteracting &&
              !this.default.shouldIgnoreMove &&
        ...
        (this.ondefaultMove = (e) => {
          if (this.isInteracting) {
            if (
              (this.emitter.trigger("defaultmove", e),
        ...
        (this.ondefaultUp = (e) => {
          this.isInteracting &&
            ...
            Ke(document.body),
            tt(document.body),
            this.emitter.trigger("defaultup", e),
            this.isDragging && (this.autoScroller.stop(), this.tryStopDrag(e)),
            this.delayTimeoutId &&
              (clearTimeout(this.delayTimeoutId),
              (this.delayTimeoutId = null)));
        });
      let n = (this.default = new Oa(e));
      n.emitter.on("defaultdown", this.ondefaultDown),
        n.emitter.on("defaultmove", this.ondefaultMove),
        n.emitter.on("defaultup", this.ondefaultUp),
        t && (n.selector = t),
        (this.mirror = new Pa()),
        (this.autoScroller = new Ua());
    }
    destroy() {
      this.default.destroy(), this.ondefaultUp({});
    }
    startDelay(e) {
    ...
    tryStartDrag(e) {
      this.isDelayEnded &&
        this.isDistanceSurpassed &&
        ((this.default.wasTouchScroll && !this.touchScrollAllowed) ||
          ((this.isDragging = !0),
          (this.mirrorNeedsRevert = !1),
          this.autoScroller.start(e.pageX, e.pageY, this.containerEl),
          this.emitter.trigger("dragstart", e),
          !1 === this.touchScrollAllowed && this.default.cancelTouchScroll()));
    }
    tryStopDrag(e) {
    ...
    setIgnoreMove(e) {
      this.default.shouldIgnoreMove = e;
    }
    setMirrorIsVisible(e) {
  ...
  class La {
    constructor(e) {
      (this.origRect = es(e)),
        (this.scrollCaches = ts(e).map((e) => new Ba(e, !0)));
    }
    destroy() {
      for (let e of this.scrollCaches) e.destroy();
    }
    ...
    isWithinClipping(e, t) {
      ...
      for (let e of this.scrollCaches)
        if (!Fa(e.getEventTarget()) && !Ni(n, e.clientRect)) return !1;
      return !0;
    }
  }
  function Fa(e) {
  ...
  class Va {
    constructor(e, t) {
      (this.useSubjectCenter = !1),
        ...
        (this.handledefaultDown = (e) => {
          ...
          (this.initialHit = null),
            ...
            this.initialHit || !this.requireInitial
              ? (t.setIgnoreMove(!1), this.emitter.trigger("defaultdown", e))
              : t.setIgnoreMove(!0);
        }),
        ...
        (this.handledefaultUp = (e) => {
          this.releaseHits(), this.emitter.trigger("defaultup", e);
        }),
        ...
        e.emitter.on("defaultdown", this.handledefaultDown),
        e.emitter.on("dragstart", this.handleDragStart),
        e.emitter.on("dragmove", this.handleDragMove),
        e.emitter.on("defaultup", this.handledefaultUp),
    ...
    processFirstCoord(e) {
      let t,
        ...
        r = n,
        i = e.subjectEl;
      i instanceof HTMLElement && ((t = es(i)), (r = Hi(r, t)));
    ...
    handleMove(e, t) {
      ...
      (!t && Ga(this.movingHit, n)) ||
        ((this.movingHit = n), this.emitter.trigger("hitupdate", n, !1, e));
    }
    prepareHits() {
      this.offsetTrackers = Dn(
        this.droppableStore,
        (e) => (e.component.prepareHits(), new La(e.el))
      );
    }
    releaseHits() {
          ...
          if (e) {
            ...
            i === s || (t.editable && t.droppable)
              ? ((o = (function (e, t, n) {
                ...
                o &&
                  ((a = Xr(n, s.getCurrentData().eventUiBases, o, s)),
                  (c.mutatedEvents = a),
                  Os(c, e.dateProfile, s) ||
                    ((l = !0),
                    (o = null),
                    (a = null),
  ...
  qa.SELECTOR = ".fc-event-draggable, .fc-event-resizable";
  const Ya = { fixedMirrorParent: yn },
    Za = {
      dateClick: yn,
      eventDragStart: yn,
      eventDragStop: yn,
  ...
  class Xa {
    constructor(e, t) {
      ...
      let n = (this.hitDragging = new Va(e, Ii));
      (n.requireInitial = !1),
    ...
    buildDragMeta(e) {
      return "object" == typeof this.suppliedDragMeta
        ? ys(this.suppliedDragMeta)
        : "function" == typeof this.suppliedDragMeta
        ? ys(this.suppliedDragMeta(e))
        : (function (e) {
            let t = (function (e, t) {
              let n = ms.dataAttrPrefix,
                r = (n ? n + "-" : "") + t;
              return e.getAttribute("data-" + r) || "";
            })(e, "event");
            return ys(t ? JSON.parse(t) : { create: !1 });
          })(e);
    }
    displayDrag(e, t) {
  ...
  class $a extends ps {
    constructor(e) {
      ...
      let t = (this.default = new Oa(e));
      t.emitter.on("defaultdown", this.handledefaultDown),
        t.emitter.on("defaultmove", this.handledefaultMove),
        t.emitter.on("defaultup", this.handledefaultUp);
    }
    destroy() {
  ...
  var Ja = No({
    ...
    componentInteractions: [
      class extends ki {
        constructor(e) {
          ...
          let t = (this.hitDragging = new Va(this.dragging, Mi(e)));
          t.emitter.on("defaultdown", this.handledefaultDown),
      ...
      class extends ki {
        constructor(e) {
            ...
            (this.handleHitUpdate = (e, t) => {
              ...
              if (e) {
                ...
                (e.componentId === t.componentId &&
                  ...
                  (r && Ns(r, e.dateProfile, n)) || ((i = !0), (r = null));
              }
              r
          ...
          (r.touchScrollAllowed = !1),
            ...
            (r.autoScroller.isEnabled = n.dragScroll);
          let i = (this.hitDragging = new Va(this.dragging, Mi(e)));
          i.emitter.on("defaultdown", this.handledefaultDown),
            i.emitter.on("dragstart", this.handleDragStart),
            i.emitter.on("hitupdate", this.handleHitUpdate),
            i.emitter.on("defaultup", this.handledefaultUp);
        ...
        constructor(e) {
          super(e),
            ...
            (this.handleHitUpdate = (e, t, n) => {
              ...
              a &&
                ((l = Xr(i, r.getCurrentData().eventUiBases, a, r)),
                (d.mutatedEvents = l),
                Os(d, e.dateProfile, r) ||
          ...
          (n.default.selector = ".fc-event-resizer"),
            (n.touchScrollAllowed = !1),
            (n.autoScroller.isEnabled = t.context.options.dragScroll);
          let r = (this.hitDragging = new Va(this.dragging, Mi(e)));
          r.emitter.on("defaultdown", this.handledefaultDown),
    ...
    calendarInteractions: [
      class {
        constructor(e) {
          (this.context = e),
            (this.isRecentdefaultDateSelect = !1),
            (this.matchesCancel = !1),
            (this.matchesEvent = !1),
            (this.onSelect = (e) => {
              e.jsEvent && (this.isRecentdefaultDateSelect = !0);
            }),
            (this.onDocumentdefaultDown = (e) => {
              let t = this.context.options.unselectCancel,
                n = ze(e.origEvent);
              (this.matchesCancel = !!Oe(n, t)),
                (this.matchesEvent = !!Oe(n, qa.SELECTOR));
            }),
            (this.onDocumentdefaultUp = (e) => {
              let { context: t } = this,
                { documentdefault: n } = this,
                r = t.getCurrentData();
              if (!n.wasTouchScroll) {
                if (r.dateSelection && !this.isRecentdefaultDateSelect) {
          ...
          let t = (this.documentdefault = new Oa(document));
          (t.shouldIgnoreMove = !0),
            (t.shouldWatchScroll = !1),
            t.emitter.on("defaultdown", this.onDocumentdefaultDown),
            t.emitter.on("defaultup", this.onDocumentdefaultUp),
            e.emitter.on("select", this.onSelect);
        }
        destroy() {
          this.context.emitter.off("select", this.onSelect),
            this.documentdefault.destroy();
        }
      },
    ],
  ...
  class ol extends Gn {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r } = e,
        i = gi(r, n.eventTimeFormat || rl, t, !0, e.defaultDisplayEventEnd);
      return p(
        io,
        Object.assign({}, e, {
          elTag: "a",
  ...
  class ll extends Gn {
    constructor() {
      super(...arguments), (this.compileSegs = Gt(cl));
    }
    render() {
      let { props: e } = this,
      ...
      return p(
        ...
        (s, a) =>
          p(
            ...
            !a.isDisabled && (t.showDayNumber || uo(i) || t.forceDayTop)
              ? p(
                  "div",
            ...
            (d += r.levelCoord - c),
              ...
              s
                ? ((d += r.thickness),
                  o &&
                    u.push({
                      seg: gl(i, r.span.start, r.span.end, n),
                      isVisible: !0,
                      isAbsolute: !0,
                      absoluteTop: r.levelCoord,
                      marginTop: 0,
        ...
        if (!i[e])
          if (this.allowReslicing) {
            const e = Object.assign(Object.assign({}, s), {
              span: hs(s.span, t.span),
            });
            (i[ds(e)] = !0), (r[o][a] = e), this.splitEntry(s, t, n);
          } else (i[e] = !0), n.push(s);
      }
  ...
  class ml extends as {
    ...
    render() {
      let { props: e, state: t, context: n } = this,
        { options: r } = n,
        i = e.cells.length,
        s = tl(e.businessHourSegs, i),
        o = tl(e.bgEventSegs, i),
        a = tl(this.getHighlightSegs(), i),
        l = tl(this.getMirrorSegs(), i),
        {
        ...
        for (let o of e) {
          ...
          s.push(
            p(
              ...
              "bg-event" === t
                ? p(fo, Object.assign({ seg: o }, pi(o, r)))
                : po(t)
            )
          );
        }
        ...
        if (e) {
          ...
          if (e.length) {
            ...
            (n.framePositions && n.framePositions.similarTo(r)) ||
              this.setState({ framePositions: new ns(t, e, !0, !1) });
          }
        }
  ...
  ml.addStateEquality({ eventInstanceHeights: Cn });
  class vl extends as {
    constructor() {
      super(...arguments),
        (this.splitBusinessHourSegs = Gt(el)),
        (this.splitBgEventSegs = Gt(el)),
        (this.splitFgEventSegs = Gt(el)),
        (this.splitDateSelectionSegs = Gt(el)),
        (this.splitEventDrag = Gt(nl)),
        (this.splitEventResize = Gt(nl)),
        (this.rowRefs = new Fs());
    }
    render() {
      let { props: e, context: t } = this,
    ...
    prepareHits() {
      (this.rowPositions = new ns(
        this.rootEl,
        this.rowRefs.collect().map((e) => e.getCellEls()[0]),
        !1,
        !0
      )),
        (this.colPositions = new ns(
          this.rootEl,
      ...
      if (this.needsScrollReset && this.props.clientWidth) {
        const e = (function (e, t) {
          ...
          t.currentRangeUnit.match(/year|month/) &&
            (n = e.querySelector(`[data-date="${Lt(t.currentDate)}-01"]`));
  ...
  var Cl = No({
    ...
    views: {
      dayGrid: {
        component: class extends Ka {
          constructor() {
            super(...arguments),
              (this.buildDayTableModel = Gt(Dl)),
              (this.headerRef = { current: null }),
              (this.tableRef = { current: null });
          }
          render() {
  ...
  class kl extends Gn {
    render() {
      return this.props.slatMetas.map((e) =>
        p("tr", { key: e.key }, p(_l, Object.assign({}, e)))
      );
    }
  }
  const Ml = an({ week: "short" });
  class Il extends as {
    constructor() {
      super(...arguments),
        (this.allDaySplitter = new Rl()),
              ...
              content: (e) =>
                p(
                  ...
                  p(
                    ...
                    e.tableColGroupNode,
                    p("tbody", null, p(kl, { slatMetas: s }))
                  ),
                  p(
                    "div",
                    { className: "fc-timegrid-now-indicator-container" },
                    p(Cs, { unit: f ? "minute" : "day" }, (e) => {
    ...
    render() {
      ...
      return p(
        Eo,
        {
          ...
          dateProfile: e.dateProfile,
          todayRange: e.todayRange,
          popoverContent: () => Xl(e.hiddenSegs, e),
          defaultGenerator: Ul,
          forceTimed: !0,
        },
        (e) =>
  ...
  function Ll(e, t) {
    ...
    return o.sort(Fl), [o.map(Vl), o[0][1]];
  }
  function Fl(e, t) {
    return t[1] - e[1];
  }
  ...
  const ql = an({ hour: "numeric", minute: "2-digit", meridiem: !1 });
  class Yl extends Gn {
    render() {
      return p(
        so,
  ...
  class Zl extends Gn {
    constructor() {
      super(...arguments), (this.sortEventSegs = Gt(ci));
    }
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
      ...
      return p(
        ...
        (t) =>
          p(
            ...
            uo(n) && p(t, { elTag: "div", elClasses: ["fc-timegrid-col-misc"] })
          )
      );
    }
    renderFgSegs(e, t, n, r, i) {
      let { props: s } = this;
      return s.forPrint ? Xl(e, s) : this.renderPositionedFgSegs(e, t, n, r, i);
    }
    renderPositionedFgSegs(e, t, n, r, i) {
      let {
        ...
        { segPlacements: v, hiddenGroups: b } = (function (e, t, n, r) {
          ...
          let { segRects: o, hiddenGroups: a } = Wl(i, n, r),
            l = [];
      ...
      return p(
        ...
        v.map((e) => {
          let { seg: s, rect: a } = e,
            ...
            c = g || Boolean(!t[l] && a),
            d = $l(a && a.span),
            m = !g && a ? this.computeSegHStyle(a) : { left: 0, right: 0 },
    ...
    renderFillSegs(e, t) {
      let { props: n, context: r } = this,
        i = Ql(e, n.date, n.slatCoords, r.options.eventMinHeight).map(
          (r, i) => {
            let s = e[i];
            return p(
              "div",
              ...
              "bg-event" === t
                ? p(
                    fo,
                    Object.assign({ seg: s }, pi(s, n.todayRange, n.nowDate))
                  )
                : po(t)
            );
          }
  ...
  class Jl extends Gn {
    constructor() {
      super(...arguments),
        (this.splitFgEventSegs = Gt(Bl)),
        (this.splitBgEventSegs = Gt(Bl)),
        (this.splitBusinessHourSegs = Gt(Bl)),
        (this.splitNowIndicatorSegs = Gt(Bl)),
        (this.splitDateSelectionSegs = Gt(Bl)),
        (this.splitEventDrag = Gt(jl)),
        (this.splitEventResize = Gt(jl)),
        (this.rootElRef = { current: null }),
        (this.cellElRefs = new Fs());
    }
    render() {
  ...
  class nc extends as {
    ...
    render() {
      ...
      return p(Cs, { unit: i ? "minute" : "day" }, (a, l) =>
        p(
          Kl,
          Object.assign(
  ...
  function sc(e, t, n, r, i) {
    let s = new Date(0),
      ...
      l =
        ...
        (function (e) {
          let t, n, r;
          for (t = ic.length - 1; t >= 0; t -= 1)
            if (((n = ft(ic[t])), (r = bt(n, e)), null !== r && r > 1))
              return n;
          return e;
        })(r),
      c = [];
  ...
  var ac = No({
    ...
    views: {
      timeGrid: {
        component: class extends Il {
          constructor() {
            super(...arguments),
              (this.buildTimeColsModel = Gt(oc)),
              (this.buildSlatMetas = Gt(sc));
          }
          render() {
            let {
                options: e,
  ...
  const dc = an({ hour: "numeric", minute: "2-digit", meridiem: "short" });
  class uc extends Gn {
    render() {
      let { props: e, context: t } = this,
        { options: n } = t,
        { seg: r, timeHeaderId: i, eventHeaderId: s, dateHeaderId: o } = e,
        a = n.eventTimeFormat || dc;
      return p(
        io,
        Object.assign({}, e, {
          elTag: "tr",
              ...
              if (!1 !== s.displayEventTime) {
                ...
                if (
                  (a.allDay
                    ...
                    ? e.isStart
                      ? (o = gi(e, t, n, null, null, l.range.start, e.end))
                      : e.isEnd
                      ? (o = gi(e, t, n, null, null, e.start, l.range.end))
                      : (c = !0)
                    : (o = gi(e, t, n)),
                  c)
                ) {
  ...
  var mc = No({
    ...
    views: {
      list: {
        component: class extends as {
          constructor() {
            super(...arguments),
              (this.computeDateVars = Gt(gc)),
              ...
              for (let n = 0; n < a.length; n += 1) {
                ...
                if (d) {
                  let a = Wt(t[n]),
                    u = o + "-" + a;
                  c.push(
                    p(lc, { key: a, cellId: u, dayDate: t[n], todayRange: l })
                  ),
                    (d = ci(d, r.eventOrder));
                  for (let t of d)
                    c.push(
  ...
  const Ec = an({ year: "numeric", month: "long" }),
    Sc = an({ month: "long" });
  function Dc(e, t) {
    return (
      e ||
    ...
    views: {
      multiMonth: {
        component: class extends as {
          constructor() {
            super(...arguments),
              (this.splitDateProfileByMonth = Gt(bc)),
              (this.buildMonthFormat = Gt(Dc)),
  ...
  return (
    aa.push(Ja, Cl, ac, mc, wc),
    (e.Calendar = class extends Oi {
      constructor(e, t = {}) {
        super(),
          (this.isRendering = !1),
          (this.isRendered = !1),
    ...
    (e.Draggable = class {
      constructor(e, t = {}) {
        ...
        (n.touchScrollAllowed = !1),
          null != t.itemSelector && (n.default.selector = t.itemSelector),
          null != t.appendTo && (n.mirror.parentNode = t.appendTo),
          n.emitter.on("defaultdown", this.handledefaultDown),
          n.emitter.on("dragstart", this.handleDragStart),
          new Xa(n, t.eventData);
      }
      destroy() {
        this.dragging.destroy();
      }
    ...
    (e.ThirdPartyDraggable = class {
      constructor(e, t) {
        ...
        e === document || e instanceof Element
          ? ((n = e), (t = t || {}))
          : (t = e || {});
        let r = (this.dragging = new $a(n));
        "string" == typeof t.itemSelector
          ? (r.default.selector = t.itemSelector)
          : n === document && (r.default.selector = "[data-event]"),
          "string" == typeof t.mirrorSelector &&
            (r.mirrorSelector = t.mirrorSelector),
          new Xa(r, t.eventData);
      }
      destroy() {
        this.dragging.destroy();
      }
