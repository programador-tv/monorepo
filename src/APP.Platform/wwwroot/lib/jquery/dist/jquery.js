...
(function (global, factory) {
  ...
  jQuery.event = {
    ...
    handlers: function (event, handlers) {
      ...
      if (
        ...
        cur.nodeType &&
        // Support: Firefox <=42
        // Suppress spec-violating clicks indicating a non-primary default button (trac-3861)
  ...
  // Do the same for defaultenter/defaultleave and defaultover/defaultout
  //
  ...
  jQuery.each(
    {
      ...
      mouseleave: "mouseout",
      defaultenter: "defaultover",
      defaultleave: "defaultout",
    },
    function (orig, fix) {
