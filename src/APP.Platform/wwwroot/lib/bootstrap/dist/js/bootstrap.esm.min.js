...
const Manipulator = {
  ...
  EVENT_defaultDOWN = "defaultdown.bs.carousel",
  EVENT_defaultUP = "defaultup.bs.carousel",
  ...
  CLASS_NAME_default_EVENT = "default-event",
  ...
  default_TYPE_TOUCH = "touch",
  default_TYPE_PEN = "pen";
class Carousel extends BaseComponent {
  ...
  _addTouchEventListeners() {
    const e = (e) => {
        !this._defaultEvent ||
        ("pen" !== e.defaultType && "touch" !== e.defaultType)
          ? this._defaultEvent || (this.touchStartX = e.touches[0].clientX)
    ...
    SelectorEngine.find(SELECTOR_ITEM_IMG, this._element).forEach((e) => {
      ...
      this._defaultEvent
        ? (EventHandler.on(this._element, EVENT_defaultDOWN, (t) => e(t)),
          EventHandler.on(this._element, EVENT_defaultUP, (e) => i(e)),
