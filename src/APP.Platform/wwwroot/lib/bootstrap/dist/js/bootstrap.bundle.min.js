...
!(function (t, e) {
  ...
  class Z extends H {
    ...
    _addTouchEventListeners() {
      const t = (t) => {
          !this._defaultEvent ||
          ("pen" !== t.defaultType && "touch" !== t.defaultType)
            ? this._defaultEvent || (this.touchStartX = t.touches[0].clientX)
      ...
      U.find(".carousel-item img", this._element).forEach((t) => {
        ...
        this._defaultEvent
          ? (P.on(this._element, "defaultdown.bs.carousel", (e) => t(e)),
            P.on(this._element, "defaultup.bs.carousel", (t) => i(t)),
            this._element.classList.add("default-event"))
  ...
  class et extends H {
    ...
    show() {
      ...
      if (this._config.parent) {
        ...
        e = U.find(".show, .collapsing", this._config.parent).filter(
          (e) => !t.includes(e)
        );
      }
  ...
  function Tt(t) {
    return "html" === ht(t)
      ? t
      : t.assignedSlot || t.parentNode || (pt(t) ? t.host : null) || At(t);
  }
  function Ot(t) {
  ...
  function Ct(t) {
    for (var e = dt(t), i = Ot(t); i && Et(i) && "static" === wt(i).position; )
      i = Ot(i);
    return i &&
      ("html" === ht(i) || ("body" === ht(i) && "static" === wt(i).position))
      ? e
      : i ||
          (function (t) {
        ...
        var n =
            "clippingParents" === e
              ? (function (t) {
                  var e = Kt(Tt(t)),
                    i =
                      ["absolute", "fixed"].indexOf(wt(t).position) >= 0 &&
                      ft(t)
                        ? Ct(t)
                        : t;
                  return ut(i)
        ...
        (("body" !== ht(e) || Vt(a)) &&
          (c =
            (n = e) !== dt(n) && ft(n)
              ...
              : Ut(n)),
        ft(e)
          ? (((h = bt(e, !0)).x += e.clientLeft), (h.y += e.clientTop))
          : a && (h.x = $t(a))),
      {
  ...
  class Le {
    ...
    _getConfig(t) {
      return (
        ((t = { ...Ce, ...("object" == typeof t ? t : {}) }).rootElement = o(
          t.rootElement
        )),
        r("backdrop", t, ke),
        t
  ...
  const Be = new Set([
    ...
    ze = (t, e) => {
      ...
      if (e.includes(i))
        return (
          !Be.has(i) || Boolean(Re.test(t.nodeValue) || We.test(t.nodeValue))
        );
  ...
  class Xe extends H {
    ...
    show() {
      ...
      M.set(n, this.constructor.DATA_KEY, this),
        ...
        this._popper
          ? this._popper.update()
          : (this._popper = fe(this._element, n, this._getPopperConfig(r))),
  ...
  P.on(
    ...
    function (t) {
      ["A", "AREA"].includes(this.tagName) && t.preventDefault(),
        l(this) || ni.getOrCreateInstance(this).show();
    }
  ),
    m(ni);
