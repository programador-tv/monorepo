...
public sealed class FreeTimeBackstage(Guid id, Guid timeSelectionId, int maxParticipants, bool ilimitado)
    : Entity(id)
{
    ...
    public static FreeTimeBackstage Create(Guid timeSelectionId, int maxParticipants, bool ilimitado)
    {
